...
practice2['teacher_note'] = practice2['teacher_note'].replace("Bài 5 thang máy DVH chẻ 8 câu CÓ Ô ĐIỀN", "Bài 5 thang máy DVH chẻ 8 câu CÓ Ô ĐIỀN") # keep
practice2['teacher_note'] += " [[br]] $\\bullet$ CÁC DẠNG BÀI MỚI (Từ BTVN đẩy lên): Bài 7 (Lãi suất Bát Tràng — lưu ý $4,5\\% = 0,045$), Bài 8 (Tuyển dụng tính điểm — gỡ rối số câu sai $= 25-x$)."
